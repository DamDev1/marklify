        ...
        <div className={tw(`flex flex-wrap my-12`)}>
          <div className={tw(`w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              <CheckCircle width={20} height={20} className={tw(`h-6 w-6 text-indigo-500`)} />
              <div className={tw(`ml-4 text-xl`)}>One-click GitHub integration</div>
            </div>
          ...
          <div className={tw(`w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              <CheckCircle width={20} height={20} className={tw(`h-6 w-6 text-indigo-500`)} />
              <div className={tw(`ml-4 text-xl`)}>AI-assisted README generation</div>
            </div>
            <p className={tw(`leading-loose text-gray-500 `)}>
          ...
          <div className={tw(`w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8`)}>
            <div className="flex items-center mb-6">
              <CheckCircle width={20} height={20} className={tw(`h-6 w-6 text-indigo-500`)} />
              <div className={tw(`ml-4 text-xl`)}>Markdown with styled previews</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
          ...
          <div className={tw(`w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              <CheckCircle width={20} height={20} className={tw(`h-6 w-6 text-indigo-500`)} />
              <div className={tw(`ml-4 text-xl`)}>One-click copy or download</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
          ...
          <div className={tw(`w-full border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              <CheckCircle width={20} height={20} className={tw(`h-6 w-6 text-indigo-500`)} />
              <div className={tw(`ml-4 text-xl`)}>Choose your preferred theme</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
          ...
          <div className={tw(`w-full md:w-1/2 lg:w-1/3 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              <CheckCircle width={20} height={20} className={tw(`h-6 w-6 text-indigo-500`)} />
              <div className={tw(`ml-4 text-xl`)}>Manage your readme's</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
